...
Future<Map<String, dynamic>> login(UserCredentials user) async {
  ...
  try {
    ...
    switch (response.statusCode) {
      case 201:
        {
          responseRequest = {"status": true, "message": jsonParsed["message"]};
          break;
        }
...
Future<Map<String, dynamic>> importSpreadsheet(String userID, String id) async {
  ...
  final data = {"spreadsheetLink": id, "userId": userID};
...
Future<Map<String, dynamic>> finishProjectRemote(
    UserCredentials user, Project project) async {

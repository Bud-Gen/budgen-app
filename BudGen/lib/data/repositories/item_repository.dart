...
class ItemRepository {
  ...
  Future<Item> getItemById(String id) async {
    ...
    final itemData =
        await _database.query(ITEM, where: 'id = ?', whereArgs: [id], limit: 1);
  ...
  Future<bool> changeFavoriteItem(Item item) async {
    ...
    final Item favoriteItem = Item(
      ...
      isFavorite: item.isFavorite != null ? !item.isFavorite : false,
    );
  ...
  Future<bool> updateItem(Item item) async {
    ...
    final itemData = await _database.query(ITEM,
